...
def cmd_write_version_info(filepath, timestamp, arch, kernel, os_name,
                            ...
                            install_path, max_concurrent_emb, max_concurrent_vlm,
                            data_scale, *extra_args):
    data = {
        "timestamp": timestamp,
        "architecture": arch,
        "kernel": kernel,
        ...
        "python_version": runtime_ver1,
        "openviking_version": runtime_ver2,
        "install_path": install_path,
        "max_concurrent_embedding": safe_int(max_concurrent_emb),
        "max_concurrent_vlm": safe_int(max_concurrent_vlm),
