...
def cmd_write_version_info(filepath, args):
    ...
    data["version_info"] = {
        ...
        "cores": cores,
        "memory_mb": mem_mb,
        "mysql_version_string": mysql_ver,
        "sysbench_version": sysbench_ver,
...
def main():
    parser = argparse.ArgumentParser(description="JSON helper for MySQL benchmark")
